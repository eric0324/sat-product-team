...
export function SlideFrontendTimer() {
  ...
  return (
    ...
    >
      <VhsHud tape="NIGHTMARE //04" chapter="STAGE 4 LIVE" />
      <NoiseOverlay />

      <div style={{ textAlign: 'center', marginBottom: 20, zIndex: 10 }}>
        <div className="mono" style={{ fontSize: 28, color: '#8a2be2', letterSpacing: 6 }}>
          ── STAGE 4 ──
        </div>
      ...
      {showPopup && (
        ...
        >
          <div style={{
            ...
            <div>「那個⋯熊頭上可以<b style={{ background: '#8a2be2', color: '#fff', padding: '0 6px' }}>長一隻角</b>嗎？超可愛！」</div>
            <div style={{
      ...
      <VhsFooter left="▶ STAGE 4 LIVE" right="NO MERCY" />
    </section>
  );
}
